...
test_that("check_gps_dist()", {
  ...
  # Warn if > 100
  expect_warning(g1 <- check_gps_dist(example_sites_clean, crs = 3161,
                                      dist_cutoff = 100, dist_by = "aru_id"),
                 "Within site distances are greater than cutoff")

  # No Warning if dist < cutoff
  expect_silent(g2 <- check_gps_dist(example_sites_clean, crs = 3161,
  ...
  expect_silent(g3 <- check_gps_dist(example_sites_clean, crs = 3161,
  ...
  expect_message(g4 <- check_gps_dist(
    example_sites_clean, crs = 3161,
  ...
  # Warning
  expect_warning(g5 <- check_gps_dist(example_sites_clean, crs = 4326,
                                     dist_cutoff = 100, dist_by = "aru_id"))
