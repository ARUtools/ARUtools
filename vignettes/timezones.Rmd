...
#| message: false
library(ARUtools)
library(lubridate) # For workding with date/tiems
...
m_mini <- filter(m, site_id %in% c("P01_1", "P06_1")) |>
  ...
  distinct() |>
  cross_join(data.frame(date_time = c("2020-05-02 05:00:00", 
                                      "2020-05-02 06:00:00",
                                      "2020-05-02 07:00:00"))) |>
...
However, if we were to incorrectly assume that the ARU unit in the central timezone
